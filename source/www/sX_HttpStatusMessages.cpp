# include "sX_HttpStatusMessages.hpp"

HttpStatusMessages::HttpStatusMessages( void ) 
{
    ...
    (*this)[HTTP_HTTP_VERSION_NOT_SUPPORTED] = "HTTP Version Not Supported";
}

string httpMethods[HTTP_AVAILABLE_METHOD] = {"GET", "PUT", "POST", "HEAD", "PATCH", "TRACE", "DELETE", "CONNECT", "OPTIONS"};