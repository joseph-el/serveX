...
class response {
    ...
    public :
        ...
        map<string, string>  getfileInformation(fs::path const&);
        ...
        void _setup_options_response();
        void _setup_head_response(string const&);

        void _setup_patch_response(string const&, bool founded_put_method = false);
